...
int Nodo::getTipo()
{
    ...
    if(this->tipo == "CHOWN")      return 34;
    if(this->tipo == "CHGRP")      return 35;
    if(this->tipo == "PAUSE")      return 36;
    if(this->tipo == "RECOVERY")   return 37;
    if(this->tipo == "LOSS")       return 38;
    if(this->tipo == "fs")         return 39;
    if(this->tipo == "user")       return 40;
    if(this->tipo == "password")   return 41;
    if(this->tipo == "group")      return 42;
    if(this->tipo == "ugo")        return 43;
    if(this->tipo == "cont")       return 44;
    if(this->tipo == "file")       return 45;
    if(this->tipo == "p")          return 46;
    if(this->tipo == "dest")       return 47;
    if(this->tipo == "r")          return 48;
    if(this->tipo == "inode")      return 49;
    if(this->tipo == "journaling") return 50;
    if(this->tipo == "block")      return 51;
    if(this->tipo == "bm_inode")   return 52;
    if(this->tipo == "bm_block")   return 53;
    if(this->tipo == "tree")       return 54;
    if(this->tipo == "sb")         return 55;
    if(this->tipo == "ruta")       return 56;
    return 0;
}

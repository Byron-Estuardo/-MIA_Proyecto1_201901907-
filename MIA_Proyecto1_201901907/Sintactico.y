...
PARAM_MKUSR: usr igual identificador { $$ = new Nodo("user",$3); }
             | usr igual cadena { $$ = new Nodo("user",$3); }
             | pwd1 igual num { $$ = new Nodo("password",$3); }
             | pwd1 igual identificador { $$ = new Nodo("password", $3); }
             | pwd1 igual password { $$ = new Nodo("password", $3); }
             | pwd1 igual cadena { $$ = new Nodo("password",$3); }
...
PARAM_EDIT: path igual ruta { $$ = new Nodo("path",$3); }
            | path igual cadena { $$ = new Nodo("path",$3); }
            | cont1 igual cadena { $$ = new Nodo("cont", $3); };

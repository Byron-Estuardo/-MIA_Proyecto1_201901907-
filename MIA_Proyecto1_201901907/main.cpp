...
void GRMBR(QString direccion, QString destino, QString extension){
...
void GRDisk(QString direccion, QString destino, QString extension){
    FILE *fp;
    FILE *graphDot;
...
void GRInode(QString direccion, QString destino, QString extension,int bm_inode_start,int inode_start,int bm_block_start){
...
void GRJournaling(QString direccion, QString destino, QString extension,int inicio_super){
    FILE *fp = fopen(direccion.toStdString().c_str(),"r");
...
void GRBlock(QString direccion, QString destino, QString extension, int bm_block_start, int block_start, int inode_start){
    FILE *fp = fopen(direccion.toStdString().c_str(),"r");
...
void GRBm_Inode_Block(QString direccion, QString destino, int start_bm, int n){
    FILE *fp = fopen(direccion.toStdString().c_str(),"rb+");
...
void GRTree(QString direccion, QString destino, QString extension, int start_super){
    FILE *fp = fopen(direccion.toStdString().c_str(),"r");
...
void GRSB(QString direccion, QString destino, QString extension, int start_super){
    FILE* fp = fopen(direccion.toStdString().c_str(),"r");
...
void GRFILE(QString direccion, QString destino, QString extension, QString name,int start_super,int n){
    FILE *fp = fopen(direccion.toStdString().c_str(),"r");
...
void GRLS(QString direccion, QString destino, QString extension, int start_super, int n, Usuario user, QString name){
    FILE *fp = fopen(direccion.toStdString().c_str(),"rb+");
...
void RREP(Nodo *raiz)
{
    ...
    if(!Bandera){
        if(BanderaPath){
            if(BanderaName){
                if(BanderaID){
                    NodoListaMount *aux = lista->getNodo(valID);
                    ...
                    if(aux !=  nullptr){
                        ...
                        system(comando2.c_str());
                        if(valName == "mbr")
                            GRMBR(aux->direccion,valPath,ext);
                        else if(valName == "disk")
                            GRDisk(aux->direccion,valPath,ext);
                            ...
                            if(index != -1){
                                ...
                                fread(&super,sizeof(SuperBloque),1,fp);
                                fclose(fp);
                                GRInode(aux->direccion,valPath,ext,super.s_bm_inode_start,super.s_inode_start,super.s_bm_block_start);
                            }else{
                                int index = buscarParticion_Logica(aux->direccion,aux->nombre);
                                if(index != -1){
                                    EBR extendedBoot;
                                    SuperBloque super;
                                    FILE *fp = fopen(aux->direccion.toStdString().c_str(),"rb+");
                            ...
                            if(index != -1){
                                ...
                                fread(&super,sizeof(SuperBloque),1,fp);
                                fclose(fp);
                                GRJournaling(aux->direccion,valPath,ext,masterboot.mbr_partition[index].part_start);
                            }else{
                            ...
                            if(index != -1){
                                ...
                                fread(&super,sizeof(SuperBloque),1,fp);
                                fclose(fp);
                                GRBlock(aux->direccion,valPath,ext,super.s_bm_block_start,super.s_block_start,super.s_inode_start);
                            }else{
                                int index = buscarParticion_Logica(aux->direccion,aux->nombre);
                                if(index != -1){
                                    EBR extendedBoot;
                            ...
                            if(index != -1){
                                ...
                                fread(&super,sizeof(SuperBloque),1,fp);
                                fclose(fp);
                                GRBm_Inode_Block(aux->direccion,valPath,super.s_bm_inode_start,super.s_inodes_count);
                            }else{
                                int index = buscarParticion_Logica(aux->direccion,aux->nombre);
                                if(index != -1){
                                    EBR extendedBoot;
                            ...
                            if(index != -1){
                                ...
                                fread(&super,sizeof(SuperBloque),1,fp);
                                fclose(fp);
                                GRBm_Inode_Block(aux->direccion,valPath,super.s_bm_block_start,super.s_blocks_count);
                            }else{
                                int index = buscarParticion_Logica(aux->direccion,aux->nombre);
                                if(index != -1){
                                    EBR extendedBoot;
                            ...
                            if(index != -1){
                                ...
                                fseek(fp,masterboot.mbr_partition[index].part_start,SEEK_SET);
                                fclose(fp);
                                GRTree(aux->direccion,valPath,ext,masterboot.mbr_partition[index].part_start);
                            }else{
                                int index = buscarParticion_Logica(aux->direccion,aux->nombre);
                                if(index != -1){
                                    EBR extendedBoot;
                                    ...
                                    fclose(fp);
                                    GRTree(aux->direccion,valPath,ext,start);
                                }
                            }
                        }else if(valName == "sb"){
                            int index = buscarParticion_Primaria_Extendida(aux->direccion,aux->nombre);
                            if(index != -1){
                                ...
                                fseek(fp,masterboot.mbr_partition[index].part_start,SEEK_SET);
                                fclose(fp);
                                GRSB(aux->direccion,valPath,ext,masterboot.mbr_partition[index].part_start);
                            }else{
                                int index = buscarParticion_Logica(aux->direccion,aux->nombre);
                                if(index != -1){
                                    EBR extendedBoot;
                                    ...
                                    int start = static_cast<int>(ftell(fp));
                                    fclose(fp);
                                    GRSB(aux->direccion,valPath,ext,start);
                                }
                            }
                            ...
                            if(index != -1){
                               ...
                               if(existe != -1){
                                   ...
                                   GRFILE(aux->direccion,valPath,ext,QString(nombre),masterboot.mbr_partition[index].part_start,existe);
                               }
                               fclose(fp);
                            }
                        }else if(valName == "ls"){
                            ...
                            if(index != -1){
                                ...
                                if(existe != -1){
                                    ...
                                    GRLS(aux->direccion,valPath,ext,masterboot.mbr_partition[index].part_start,existe,user,QString(nombre));
                                }
                                else
